  ...
  grunt.initConfig({
    ...
    clean: {
      dist: {
        files: [
          {
            dot: true,
            src: [".tmp","<%= yeoman.dist %>/*" ,"!<%= yeoman.dist %>/WEB-INF*", "!<%= yeoman.dist %>/.git*"]
          }
        ]
      },
      all: [".tmp", ".sass-cache", "readme.md", "webapp/bower_components", "documentation/jade", "documentation/config.codekit", "landing/jade", "landing/config.codekit", "node_modules", ".git"],
      server: ".tmp"
    },
    jshint: {
      options: {
    ...
    injector: {
      ...
      local_dependencies: {
        files: {
          "<%= yeoman.app %>/index.html": [
            "<%= yeoman.app %>/template/**/*.module.js",
            "<%= yeoman.app %>/template/**/*.js",
            "!" + "<%= yeoman.app %>/**/*.spec.js"
          ]
        }
      },
    ...
    compass: {
      options: {
        ...
        cssDir: "styles",
        generatedImagesDir: "styles/ui/images/",
    ...
    concurrent: {
      ...
      scssServer: ["scss:server", "copy:styles"],
      scssDist: ["scss:dist", "copy:styles", "htmlmin"]
    },
    cssmin: {
      options: {
